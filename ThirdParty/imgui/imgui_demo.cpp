...
//---------------------------------------------------
// PLEASE DO NOT REMOVE   FILE FROM YOUR PROJECT!
//---------------------------------------------------
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    {
        ImGui::SeparatorText("ABOUT   DEMO:");
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::EndDisabled();
            ImGui::SameLine(); HelpMarker("First calls to Begin()/BeginChild() will return false.\n\n  OPTION IS DISABLED because it needs to be set at application boot-time to make sense. Showing the disabled option is a way to make this feature easier to discover.");
...
static void DemoWindowWidgetsText()
{
    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("UTF-8 Text"))
        {
            ...
            // - FOR   DEMO FILE ONLY, BECAUSE WE WANT TO SUPPORT OLD COMPILERS, WE ARE *NOT* INCLUDING RAW UTF-8
            //   CHARACTERS IN   SOURCE FILE. Instead we are encoding a few strings with hexadecimal constants.
...
//   IS A DEMO FOR ADVANCED USAGE OF DockSpace().
...
void ShowExampleAppDockSpace(bool* p_open)
{
    ...
    // REMINDER:   IS A DEMO FOR ADVANCED USAGE OF DockSpace()!
