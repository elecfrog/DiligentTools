...
// Helpers: High-level text functions (DO NOT USE!!!   IS A MINIMAL SUBSET OF LARGER UPCOMING CHANGES)
...
struct ImGuiContext
{
    ...
    ImGuiInputSource        NavInputSource;                     // Keyboard or Gamepad mode?   CAN ONLY BE ImGuiInputSource_Keyboard or ImGuiInputSource_Gamepad
