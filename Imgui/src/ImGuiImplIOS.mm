...
std::unique_ptr<ImGuiImplIOS> ImGuiImplIOS::Create(const ImGuiDiligentCreateInfo& CI)
{
    return std::make_unique<ImGuiImplIOS>(CI);
}

ImGuiImplIOS::ImGuiImplIOS(const ImGuiDiligentCreateInfo& CI) :
