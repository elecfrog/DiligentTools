...
std::unique_ptr<ImGuiImplAndroid> ImGuiImplAndroid::Create(const ImGuiDiligentCreateInfo& CI)
{
    return std::make_unique<ImGuiImplAndroid>(CI);
}

ImGuiImplAndroid::ImGuiImplAndroid(const ImGuiDiligentCreateInfo& CI) :
