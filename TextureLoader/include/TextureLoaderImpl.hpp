...
public:
    ...
    virtual void DG_CALL_TYPE CreateTexture(IRenderDevice* pDevice,
                                                  ITexture**     ppTexture) override final;

    virtual const TextureDesc& DG_CALL_TYPE GetTextureDesc() const override final
    {
        return m_TexDesc;
    }

    virtual const TextureSubResData& DG_CALL_TYPE GetSubresourceData(UInt32 MipLevel,
    ...
    virtual TextureData DG_CALL_TYPE GetTextureData() override final
    {
